...
public partial class MAVLink
{
    ...
    public static message_info[] MAVLINK_MESSAGE_INFOS = new message_info[] {
        ...
        new message_info(227, "ATMOSPHERE_OUTPUT_STATUS", 80,  8,  8,  typeof( mavlink_atmos_t )),
    ...
    [StructLayout(LayoutKind.Sequential, Pack = 1, Size = 8)]
    ///<summary> Metrics typically displayed on a HUD for fixed wing aircraft. </summary>
    public struct mavlink_atmos_t
    {
        public mavlink_atmos_t(float temperature, float humidity)
        {
        ...
        /// <summary>mavlink_atmos_t </summary>
        [Units("[degC]")]
        [Description("Current temperature in atmos units (degC).")]
        public float temperature;
        /// <summary>mavlink_atmos_t </summary>
        [Units("[%]")]
        [Description("Current humidity in atmos units (%).")]
